		...
		<div className = 'work section-p bg-grey' id = "work">
			...
			<div className = 'container'>
				<div className = 'work-content'>
					...
					<h3 className='text-brown'>Sitios de <span className ='text-dark'>Interes</span></h3>
					<p className = 'text'>Disfruta de los Mejores Destinos</p>
				</div>
			...
			<div className = 'work-item text-center' key = {index} onClick = {() => setImageOnModal(work.image)}>
					...
					<span className = 'work-item-icon'><BsPlusLg size= {38} className = "text-brown" />
					</span>
					</div>	
					)
					})
